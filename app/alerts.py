"""Logic kiem tra canh bao gia va gui tin nhan Telegram chu dong.

Tach khoi app/scheduler.py de KHONG keo theo apscheduler: tren Vercel viec nay do
Vercel Cron kich hoat (app/web/cron.py), khong co apscheduler trong bundle.
Che do chay lien tuc (Docker/VPS) thi app/scheduler.py boc ham nay vao mot job.
"""
